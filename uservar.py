...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR aquamarine][B]SMPL[/B][/COLOR]Wizard'
BUILDERNAME = 'SMPLWizard'
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing SMPLWizard.\n\nContact us on Github at http://www.github.com/nosanctuary/plugin.program.smplwizard/'
